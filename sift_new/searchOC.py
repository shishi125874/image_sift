...
image_path = '/Users/shi/Downloads/256_ObjectCategories/003.backpack/003_0005.jpg'

# Load the classifier, class names, scaler, number of clusters and vocabulary
im_features, image_paths, idf, numWords, voc = joblib.load("bofvoc1.pkl")
...
for i, ID in enumerate(rank_ID[0][0:2]):
    ...
    img_path = '/Users/shi/Downloads/256_ObjectCategories/' + img_nps + '.jpg'
    img = cv2.imread(img_path)
    cv2.imshow(str(img_nps), img)
